...
function initMap() {
    ...
    const areaCoords = {
        'library': [34.1158, 108.9347],    // 图书馆
        'dorm-a': [34.1128, 108.9357],      // 宿舍楼A区
        'dorm-b': [34.1118, 108.9327],      // 宿舍楼B区
        'canteen': [34.1133, 108.9332],     // 食堂 - 往东北500米
        'playground': [34.1123, 108.9322],   // 操场 - 往东北500米
        'teaching': [34.1148, 108.9327],    // 教学楼
        'garden': [34.1138, 108.9342]       // 花园
    };
