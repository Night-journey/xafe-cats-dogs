...
function initMap() {
    ...
    // 西安财经大学坐标 (近似中心位置)
    const campusCenter = [34.1465, 108.9068];
    
    // 西安财经大学长安校区各地点的坐标
    const areaCoords = {
        'library': [34.1485, 108.9078],    // 图书馆
        'dorm-a': [34.1455, 108.9085],      // 宿舍楼A区
        'dorm-b': [34.1445, 108.9055],      // 宿舍楼B区
        'canteen': [34.1435, 108.9045],     // 食堂
        'playground': [34.1425, 108.9035],   // 操场
        'teaching': [34.1475, 108.9065],    // 教学楼
        'garden': [34.1465, 108.9085]       // 花园
    };
