...
function initMap() {
    ...
    // 西安财经大学坐标 (近似中心位置)
    const campusCenter = [34.1111, 108.9304];
    
    // 西安财经大学长安校区各地点的坐标（往东北调整300米）
    const areaCoords = {
        'library': [34.1131, 108.9314],    // 图书馆
        'dorm-a': [34.1101, 108.9324],      // 宿舍楼A区
        'dorm-b': [34.1091, 108.9294],      // 宿舍楼B区
        'canteen': [34.1081, 108.9274],     // 食堂
        'playground': [34.1071, 108.9264],   // 操场
        'teaching': [34.1121, 108.9294],    // 教学楼
        'garden': [34.1111, 108.9309]       // 花园
    };
