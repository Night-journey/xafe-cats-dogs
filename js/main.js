...
function initMap() {
    ...
    // 西安财经大学坐标 (近似中心位置)
    const campusCenter = [34.1075, 108.9260];
    
    // 西安财经大学长安校区各地点的坐标（继续向东南调整）
    const areaCoords = {
        'library': [34.1095, 108.9270],    // 图书馆
        'dorm-a': [34.1065, 108.9280],      // 宿舍楼A区
        'dorm-b': [34.1055, 108.9250],      // 宿舍楼B区
        'canteen': [34.1045, 108.9230],     // 食堂
        'playground': [34.1035, 108.9220],   // 操场
        'teaching': [34.1085, 108.9250],    // 教学楼
        'garden': [34.1075, 108.9265]       // 花园
    };
