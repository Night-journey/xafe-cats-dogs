...
function initMap() {
    ...
    // 西安财经大学坐标 (近似中心位置)
    const campusCenter = [34.1084, 108.9271];
    
    // 西安财经大学长安校区各地点的坐标（回退到上次位置+100米东北）
    const areaCoords = {
        'library': [34.1104, 108.9281],    // 图书馆
        'dorm-a': [34.1074, 108.9291],      // 宿舍楼A区
        'dorm-b': [34.1064, 108.9261],      // 宿舍楼B区
        'canteen': [34.1054, 108.9241],     // 食堂
        'playground': [34.1044, 108.9231],   // 操场
        'teaching': [34.1094, 108.9261],    // 教学楼
        'garden': [34.1084, 108.9276]       // 花园
    };
