...
function initMap() {
    ...
    // 西安财经大学坐标 (近似中心位置)
    const campusCenter = [34.1400, 108.9100];
    
    // 西安财经大学长安校区各地点的坐标（调整后）
    const areaCoords = {
        'library': [34.1420, 108.9110],    // 图书馆
        'dorm-a': [34.1390, 108.9120],      // 宿舍楼A区
        'dorm-b': [34.1380, 108.9090],      // 宿舍楼B区
        'canteen': [34.1370, 108.9070],     // 食堂
        'playground': [34.1360, 108.9060],   // 操场
        'teaching': [34.1410, 108.9090],    // 教学楼
        'garden': [34.1400, 108.9105]       // 花园
    };
